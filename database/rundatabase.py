        ...
        def send_data(self, state):
            ...
            if state == SMNState.SCANNING_WALLET:
                ...
                process = subprocess.Popen(
                            [r"C:\xampp\php\php.exe", r"C:\Users\basti\source\repos\databaserun\check2.php", "final_check", json_arg],
                ...
                json_arg = json.dumps(payload)
                process = subprocess.Popen(
                            [r"C:\xampp\php\php.exe", r"C:\Users\basti\source\repos\databaserun\check2.php","check_boxid", json_arg],
                            stdout=subprocess.PIPE,
                            stderr=subprocess.PIPE,
                            text=True
                        )
